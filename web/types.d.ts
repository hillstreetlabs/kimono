...
declare module "ethjs" {
  export default class Eth {
    personal_sign: (msg: string, addr: string) => Promise<string>;
    static fromUtf8: (str: string, type: string) => string;
    static fromWei: (str: string | number | BN, type: string) => BN;
  }
}
...
// Thanks to https://gist.github.com/ColtonProvias/e9f1ebbfa9dcea4aa04d4e90bf0c42d5
declare module "bn.js" {
  ...
  export default class BN {
    ...
    toArrayLike(
      arrayType: ArrayLike<any> | Buffer,
      endian: string,
      length: number
    ): ArrayLike<any>;
    bitLength(): number;
